...
```shell-session
AIceBear@htb[/htb]$ git clone https://github.com/utoni/ptunnel-ng.git
```
...
```shell-session
AIceBear@htb[/htb]$ sudo ./autogen.sh 
```
...
```shell-session
AIceBear@htb[/htb]$ scp -r ptunnel-ng ubuntu@10.129.202.64:~/
```
...
```shell-session
AIceBear@htb[/htb]$ sudo ./ptunnel-ng -p10.129.202.64 -l2222 -r10.129.202.64 -R22
...
```shell-session
AIceBear@htb[/htb]$ ssh -p2222 -lubuntu 127.0.0.1
...
```shell-session
AIceBear@htb[/htb]$ ssh -D 9050 -p2222 -lubuntu 127.0.0.1
...
```shell-session
AIceBear@htb[/htb]$ proxychains nmap -sV -sT 172.16.5.19 -p3389
