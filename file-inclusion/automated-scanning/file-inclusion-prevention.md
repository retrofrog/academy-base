...
<pre class="language-bash"><code class="lang-bash">sudo nano /etc/php/7.4/apache2/php.ini
#disable_functions =exec,passthru,shell_exec,system,proc_open,popen,curl_exec,curl_multi_exec,parse_ini_file,show_source
service apache2 restart
<strong>sudo vim /var/www/html/test.php
</strong>#&#x3C;pre>
#  &#x3C;?php
#    system("whoami");
#  ?>
...
curl 10.129.234.126/test.php
#[php7:warn] [pid 1640] [client 10.10.14.198:42006] PHP Warning:  system() has been disabled for security reasons in /var/www/html/test.php on line 3
</code></pre>
