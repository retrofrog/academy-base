...
```bash
AIceBear@htb[/htb]$ sudo nmap <target> -sC
```
...
```bash
AIceBear@htb[/htb]$ sudo nmap <target> --script <category>
```
...
```bash
AIceBear@htb[/htb]$ sudo nmap <target> --script <script-name>,<script-name>,...
```
...
```bash
AIceBear@htb[/htb]$ sudo nmap 10.129.2.28 -p 25 --script banner,smtp-commands
...
```bash
AIceBear@htb[/htb]$ sudo nmap 10.129.2.28 -p 80 -A
...
```bash
AIceBear@htb[/htb]$ sudo nmap 10.129.2.28 -p 80 -sV --script vuln 
