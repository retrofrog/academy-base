...
```shell-session
AIceBear@htb[/htb]$ curl -I https://www.inlanefreight.com
...
```shell-session
AIceBear@htb[/htb]$ curl https://www.inlanefreight.com -A 'Mozilla/5.0'
...
```bash
curl http://94.237.62.195:59261/flag_327a6c4304ad5938eaf0efb6cc3e53dc.txt
