...
```shell-session
AIceBear@htb[/htb]$ curl -X POST -d 'username=admin&password=admin' http://<SERVER_IP>:<PORT>/
...
```shell-session
AIceBear@htb[/htb]$ curl -X POST -d 'username=admin&password=admin' http://<SERVER_IP>:<PORT>/ -i
...
```shell-session
AIceBear@htb[/htb]$ curl -b 'PHPSESSID=c1nsa6op7vtk7kdis7bcnbadf1' http://<SERVER_IP>:<PORT>/
...
```shell-session
AIceBear@htb[/htb]$ curl -X POST -d '{"search":"london"}' -b 'PHPSESSID=c1nsa6op7vtk7kdis7bcnbadf1' -H 'Content-Type: application/json' http://<SERVER_IP>:<PORT>/search.php
["London (UK)"]
```
...
```bash
curl -X POST -d 'username=admin&password=admin' http://94.237.50.221:32449 -i
#PHPSESSID=osg0bubeaanit3q983kdp9htit
curl -b 'PHPSESSID=osg0bubeaanit3q983kdp9htit' http://94.237.50.221:32449/
curl -H 'Cookie: PHPSESSID=osg0bubeaanit3q983kdp9htit' http://94.237.50.221:32449/
curl -X POST -d '{"search":"london"}' -b 'PHPSESSID=osg0bubeaanit3q983kdp9htit' -H 'Content-Type: application/json' http://94.237.50.221:32449/search.php
curl -X POST -d '{"search":"flag"}' -b 'PHPSESSID=osg0bubeaanit3q983kdp9htit' -H 'Content-Type: application/json' http://94.237.50.221:32449/search.php
