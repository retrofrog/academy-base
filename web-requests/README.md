...
```shell-session
AIceBear@htb[/htb]$ curl inlanefreight.com
...
```shell-session
AIceBear@htb[/htb]$ curl -O inlanefreight.com/index.html
AIceBear@htb[/htb]$ ls
index.html
```
...
```shell-session
AIceBear@htb[/htb]$ curl -s -O inlanefreight.com/index.html
```
...
```bash
curl http://83.136.252.214:47536/download.php
HTB{64$!c_cURL_u$3r}  
```
